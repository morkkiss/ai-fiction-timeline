...
<input type="text" placeholder="Search readings...">
  ...
  var SEV = {
    ...
    info: { dot: "\u25CF", colorClass: "text-blue-900", borderClass: "border-l-blue-900", chipClass: "bg-blue-900 text-white", tagClass: "bg-blue-50 text-blue-900 border-blue-200", label: "INFO" }
  };
  ...
  function OnboardingModal({ onAgree, onDecline }) {
    return /* @__PURE__ */ React.createElement("div", { role: "dialog", "aria-modal": "true", "aria-labelledby": "tls-onboarding-title", className: "fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4" }, /* @__PURE__ */ React.createElement("div", { className: "w-full max-w-3xl rounded-xl border border-slate-200 bg-white p-4.5 shadow-2xl" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-baseline justify-between gap-2 mb-2.5" }, /* @__PURE__ */ React.createElement("h2", { id: "tls-onboarding-title", className: "m-0 text-lg font-semibold text-blue-900" }, "Welcome to the Faculty WCAG Checker")), /* @__PURE__ */ React.createElement("p", { className: "mb-2 text-sm leading-6 text-slate-700" }, "This tool checks the HTML version of a course page or document for common accessibility problems. It is meant for technical users who already have an HTML file. If you don't, start with the Field Guide instead \u2014 it walks through Word, Google Docs, PowerPoint, and PDFs in plain language."), /* @__PURE__ */ React.createElement("p", { className: "mb-2 text-sm leading-6 text-slate-700" }, "Nothing you paste leaves your browser. The check runs locally. The tool does not certify compliance and does not replace manual review."), /* @__PURE__ */ React.createElement("p", { className: "mb-2 text-sm leading-6 text-slate-700" }, /* @__PURE__ */ React.createElement("strong", null, "Where do I get HTML?"), ' In Brightspace, open the page editor and click "View Source." In Word, File \u2192 Save As \u2192 Web Page. In Google Docs, File \u2192 Download \u2192 Web Page. Open the resulting file in a text editor and copy everything.'), /* @__PURE__ */ React.createElement("div", { className: "mt-3 flex items-center justify-end gap-2" }, /* @__PURE__ */ React.createElement(
      ...
      "button",
      {
        type: "button",
        onClick: onAgree,
        className: "rounded border border-blue-900 bg-blue-900 px-3 py-1.5 text-xs font-bold text-white"
      },
      "CONTINUE"
    ))));
  }
...
<p>Website owner: ${APP_NAME}</p>
    ...
    return /* @__PURE__ */ React.createElement(ScanErrorBoundary, { key: boundaryVersion, onReset: resetAfterBoundaryError, onError: (error) => setScanError(error && error.message || "The checker encountered a rendering error.") }, /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-[linear-gradient(180deg,#f8fbff_0%,#eef4fb_42%,#f8fafc_100%)] text-slate-900" }, /* @__PURE__ */ React.createElement("style", null, `
      ...
      `), /* @__PURE__ */ React.createElement("a", { href: "#main-content", className: "tls-skip-link" }, "Skip to main content"), /* @__PURE__ */ React.createElement("header", { className: "flex items-center justify-between gap-3 border-b border-slate-200 bg-white/90 px-7 py-5 shadow-[0_12px_32px_-26px_rgba(15,23,42,0.35)] backdrop-blur flex-wrap" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: "mb-0.5 flex items-center gap-2 text-blue-900" }, /* @__PURE__ */ React.createElement("span", { className: "text-2xl font-bold" }, "Faculty WCAG Checker")), /* @__PURE__ */ React.createElement("div", { className: "text-xs text-slate-600 tracking-wide" }, "Prepared by Morgan Talty \xB7 faculty accessibility audit tool")), /* @__PURE__ */ React.createElement("div", { className: "text-xs text-slate-600 text-right leading-6" }, /* @__PURE__ */ React.createElement("div", { className: "relative mb-1 inline-flex" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: copyShareUrl, className: "rounded border border-blue-900 bg-blue-900 px-3 py-1.5 text-xs font-semibold tracking-wide text-white" }, "Share This Tool"), /* @__PURE__ */ React.createElement("span", { className: `pointer-events-none absolute right-0 top-full mt-1 whitespace-nowrap rounded border border-slate-300 bg-white px-2 py-1 text-xs text-slate-700 shadow-sm transition-opacity ${shareCopied ? "opacity-100" : "opacity-0"}` }, "Link copied \u2014 share with colleagues")), /* @__PURE__ */ React.createElement("br", null), "WCAG 2.1 AA deadline support", /* @__PURE__ */ React.createElement("br", null), "April 24, 2026 \xB7 Title II")), /* @__PURE__ */ React.createElement("main", { id: "main-content", className: "mx-auto max-w-5xl p-6 outline-none", tabIndex: "-1" }, /* @__PURE__ */ React.createElement("nav", { "aria-label": "Toolkit navigation", className: "mb-4 flex flex-wrap gap-2 text-sm" }, /* @__PURE__ */ React.createElement("a", { href: "./", className: "rounded border border-slate-300 bg-white px-3 py-1.5 text-blue-900 hover:bg-blue-50 no-underline" }, "\u2190 Toolkit Start"), /* @__PURE__ */ React.createElement("a", { href: "./", className: "rounded border border-slate-300 bg-white px-3 py-1.5 text-blue-900 hover:bg-blue-50 no-underline" }, "Field Guide (plain language)"), /* @__PURE__ */ React.createElement("a", { href: "Faculty_WCAG_Routing_Guide_2026-04-30.html", className: "rounded border border-slate-300 bg-white px-3 py-1.5 text-blue-900 hover:bg-blue-50 no-underline" }, "Routing Guide"), /* @__PURE__ */ React.createElement("a", { href: "Faculty_Examples_2026-04-30.html", className: "rounded border border-amber-300 bg-amber-50 px-3 py-1.5 text-amber-900 hover:bg-amber-100 no-underline" }, "Examples")), /* @__PURE__ */ React.createElement("div", { className: `mb-2.5 text-xs font-medium ${scanError ? "text-red-900" : "text-blue-900"}`, role: "status", "aria-live": "polite", "aria-atomic": "true" }, statusText, displayError ? /* @__PURE__ */ React.createElement("div", { className: "mt-1.5 text-red-900" }, displayError) : null), /* @__PURE__ */ React.createElement("section", { className: "mb-5 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_18px_44px_-32px_rgba(15,23,42,0.38)]" }, /* @__PURE__ */ React.createElement("div", { className: "border-b border-slate-200 bg-slate-50 px-4 py-3 text-xs font-semibold tracking-[0.18em] text-slate-500" }, "FAST FACULTY AUDIT"), /* @__PURE__ */ React.createElement("div", { className: "grid gap-4 p-4 md:grid-cols-[1.6fr_1fr]" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { className: "text-xl font-bold text-slate-950" }, "Paste an HTML version of a course page, run an audit, review what still needs human attention."), /* @__PURE__ */ React.createElement("p", { className: "mt-2 max-w-2xl text-sm leading-6 text-slate-700" }, 'If the word "HTML" feels unfamiliar, start with the ', /* @__PURE__ */ React.createElement("a", { href: "./", className: "font-semibold text-blue-800 underline-offset-2 hover:underline" }, "Field Guide"), " \u2014 it walks through Word, Google Docs, PowerPoint, and PDFs in plain language without ever needing you to touch HTML. This checker is the advanced tool for course pages you can export as HTML."), /* @__PURE__ */ React.createElement("details", { className: "mt-2 rounded border border-slate-200 bg-slate-50 p-3 text-sm text-slate-700" }, /* @__PURE__ */ React.createElement("summary", { className: "cursor-pointer font-semibold text-blue-900" }, "Where do I get HTML to paste here?"), /* @__PURE__ */ React.createElement("ul", { className: "mt-2 ml-5 list-disc space-y-1" }, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("strong", null, "Brightspace page:"), ' open the page editor \u2192 click the source-view button (often labeled "</>" or "View Source") \u2192 copy everything.'), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("strong", null, "Word document:"), ' File \u2192 Save As \u2192 choose "Web Page" \u2192 open the resulting .html file in a text editor \u2192 copy.'), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("strong", null, "Google Doc:"), " File \u2192 Download \u2192 Web Page (.html, zipped) \u2192 unzip, open the .html file in a text editor \u2192 copy."), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("strong", null, "Course website:"), " in your browser, right-click the page \u2192 View Page Source \u2192 copy.")), /* @__PURE__ */ React.createElement("p", { className: "mt-2 text-xs text-slate-600" }, "Nothing you paste leaves your browser. The check runs locally on your machine.")), /* @__PURE__ */ React.createElement("p", { className: "mt-2 max-w-2xl text-sm leading-6 text-slate-600" }, "Start with UMaine's official page, then use this tool when you need a page-level answer to the question faculty actually ask next: what is wrong here, and what can I do about it first?", " ", /* @__PURE__ */ React.createElement("a", { href: "https://www.maine.edu/equal-opportunity/title-ii-regulations/", target: "_blank", rel: "noopener noreferrer", className: "font-semibold text-blue-800 underline-offset-2 hover:underline" }, "UMaine Title II page"))), /* @__PURE__ */ React.createElement("div", { className: "grid gap-2 text-sm text-slate-700" }, /* @__PURE__ */ React.createElement("div", { className: "rounded-xl border border-slate-200 bg-slate-50 px-3 py-2" }, /* @__PURE__ */ React.createElement("strong", { className: "text-slate-900" }, "Does:"), " page-level triage, optional rendered checks, safe limited fixes, clearer next steps"), /* @__PURE__ */ React.createElement("div", { className: "rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 text-amber-950" }, /* @__PURE__ */ React.createElement("strong", { className: "text-amber-950" }, "Does not:"), " certify legal compliance or replace manual review")))), /* @__PURE__ */ React.createElement("div", { className: "mb-5 rounded border border-slate-200 bg-slate-50 px-4 py-2.5 text-xs text-slate-500" }, "Free educational accessibility resource. Not an official University of Maine product. No vendor relationship is created. For formal institutional procurement or paid services, follow applicable conflict-of-interest and procurement procedures."), /* @__PURE__ */ React.createElement("section", { className: "overflow-hidden rounded-2xl border border-slate-200 bg-white mb-5 shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)]" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center border-b border-slate-200" }, /* @__PURE__ */ React.createElement("div", { className: "px-4 py-2.5 text-xs font-bold tracking-wide text-blue-900" }, /* @__PURE__ */ React.createElement("label", { htmlFor: "course-html-input", className: "text-blue-900" }, "Course HTML")), /* @__PURE__ */ React.createElement("div", { className: "flex-1" }), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        onClick: () => {
        ...
        className: "bg-transparent px-4 py-2.5 text-xs font-medium tracking-wide text-blue-900 cursor-pointer"
      },
      "load sample \u2192"
      ...
      "button",
      {
        ...
        className: `px-5 py-2.5 text-xs font-semibold tracking-wide transition ${tab === t ? "bg-white text-blue-900 border-b-2 border-blue-900" : "bg-transparent text-slate-500 border-b-2 border-transparent"}`
      },
      label,
      ...
      "button",
      {
        ...
        className: `rounded border px-3 py-1.5 text-xs font-semibold tracking-wide ${findingCategory === "wcag" ? "bg-blue-50 border-blue-900 text-blue-900" : "bg-transparent border-slate-300 text-slate-600"}`
      },
      ...
      "button",
      {
        ...
        className: `rounded border px-3 py-1.5 text-xs font-semibold tracking-wide ${filterSev === f ? "bg-indigo-50 border-blue-900 text-blue-900" : "bg-transparent border-slate-300 text-slate-500"}`
      },
      label,
      " (",
      count,
      ...
      ), isExp && /* @__PURE__ */ React.createElement("div", { id: `issue-${f.id}-details`, className: "border-t border-slate-200 bg-slate-50 p-3" }, f.fix && /* @__PURE__ */ React.createElement("div", { className: "mb-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "mb-1 text-xs font-bold tracking-wide text-green-800" }, "AUTOMATED CHECK RESULT"), /* @__PURE__ */ React.createElement("div", { className: "text-sm leading-6 text-slate-700" }, f.fix)), /* @__PURE__ */ React.createElement("div", { className: "mb-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "mb-1 text-xs font-bold tracking-wide text-blue-900" }, "WHY IT MATTERS"), /* @__PURE__ */ React.createElement("div", { className: "text-sm leading-6 text-slate-700" }, f.guidance && f.guidance.why || "This can affect student accessibility.")), /* @__PURE__ */ React.createElement("div", { className: "mb-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "mb-1 text-xs font-bold tracking-wide text-blue-900" }, "HOW TO FIX"), /* @__PURE__ */ React.createElement("div", { className: "text-sm leading-6 text-slate-700" }, f.guidance && f.guidance.how || "Update the flagged element to follow the rule."), f.guidance && f.guidance.example && /* @__PURE__ */ React.createElement("pre", { className: "mt-2 overflow-auto whitespace-pre-wrap break-all rounded border border-green-200 bg-white p-2 text-xs text-green-800" }, f.guidance.example)), /* @__PURE__ */ React.createElement("div", { className: "mb-2" }, /* @__PURE__ */ React.createElement("div", { className: "mb-1 text-xs font-bold tracking-wide text-slate-500" }, "WHERE TO CHANGE"), /* @__PURE__ */ React.createElement("div", { className: "text-sm leading-6 font-mono text-slate-700" }, f.where || "Not tied to a single element (layout-wide check).")), f.element && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "mb-1 text-xs font-bold tracking-wide text-slate-500" }, "ELEMENT"), /* @__PURE__ */ React.createElement("pre", { className: "mt-0 overflow-auto whitespace-pre-wrap break-all rounded border border-green-200 bg-white p-2 text-xs text-green-800" }, f.element))));
      ...
      const s = SEV[f.severity] || SEV.info;
      return /* @__PURE__ */ React.createElement("div", { key: f.id, className: `mb-2 rounded border border-slate-200 bg-white p-3 ${s.borderClass}` }, /* @__PURE__ */ React.createElement("div", { className: "mb-1 flex flex-wrap items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: s.colorClass }, s.dot), /* @__PURE__ */ React.createElement("span", { className: `rounded bg-blue-50 px-1.5 py-0.5 text-xs font-bold text-blue-900` }, f.criterion), /* @__PURE__ */ React.createElement("span", { className: `text-xs font-bold ${s.colorClass}` }, s.label)), /* @__PURE__ */ React.createElement("div", { className: "text-sm text-slate-700" }, f.issue), /* @__PURE__ */ React.createElement("div", { className: "mt-2 text-xs text-slate-600" }, f.guidance && f.guidance.how || f.fix), f.guidance && f.guidance.example && /* @__PURE__ */ React.createElement("pre", { className: "mt-2 overflow-auto whitespace-pre-wrap break-all rounded border border-green-200 bg-slate-50 p-2 text-xs text-green-800" }, f.guidance.example), f.fix && /* @__PURE__ */ React.createElement("div", { className: "mt-1.5 text-xs text-slate-500" }, "Fix: ", f.fix));
